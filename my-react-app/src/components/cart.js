                                            ...
                                            <td className="product-col">
                                                <div className="product">
                                                    <figure className="product-media">
                                                        <a href="#">
                                                            <img src={require("../assets/images/jea2.webp")} alt="Product image" />
                                                        </a>
                                                    </figure>
                                        ...
                                        <tr>
                                            <td className="product-col">
                                                <div className="product">
                                                    ...
                                                    <h3 className="product-title">
                                                        <a href="#">Blue utility pinafore denim jeans</a>
                                                    </h3>
                                                </div>
                                            </td>
                                            <td className="price-col">₹176.00</td>
                                            <td className="quantity-col">
                                                <div className="cart-product-quantity">
                                                    <input type="number" className="form-control" value="1" min="1" max="10" step="1" data-decimals="0" required />
                                                </div>
                                            </td>
                                            <td className="total-col">₹176.00</td>
                                            <td className="remove-col"><button className="btn-remove"><i className="icon-close"></i></button></td>
                                        </tr>
                                    </tbody>
                                </table>
